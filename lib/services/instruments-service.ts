...
export default class InstrumentsService {
  ...
  async getCryptocurrencies(symbols: string[] = []) {
    ...
    const cryptocurrencies = await this.httpClient.getData(
  ...
  async getSingleCryptocurrency(symbol: string) {
    ...
    const singleCryptocurrency = await this.httpClient.getData(
      `/instruments/cryptocurrencies/${encodedSymbol}`,
      {},
      {}
    );
  ...
  async getActiveEquities(queryParams = {}) {
    ...
    const activeEquities = await this.httpClient.getData(
  ...
  async getEquityDefinitions(queryParams = {}) {
    ...
    const equityDefinitions = await this.httpClient.getData(
  ...
  async getSingleEquity(symbol: string) {
    ...
    const singleEquity = await this.httpClient.getData(
  ...
  async getEquityOptions(
    ...
    if (!Array.isArray(symbols) || symbols.length === 0) {
      throw new Error(
        "Symbols are required for InstrumentService.getEquityOptions"
      );
    }

    //Returns a set of equity options given one or more symbols
    const queryParams = { symbols, active, withExpired };
    const equityOptions = await this.httpClient.getData(
  ...
  async getSingleEquityOption(symbol: string, queryParams = {}) {
    ...
    const singleOption = await this.httpClient.getData(
  ...
  async getFutures(queryParams = {}) {
    ...
    const futures = await this.httpClient.getData(
      `/instruments/futures`,
      {},
      queryParams
    );
  ...
  async getSingleFuture(symbol: string) {
    ...
    const singleFuture = await this.httpClient.getData(
  ...
  async getFutureOptionsProducts() {
    ...
    const futureOptionsProducts = await this.httpClient.getData(
  ...
  async getSingleFutureOptionProduct(exchange: string, rootSymbol: string) {
    ...
    const singleFutureOptionProduct = await this.httpClient.getData(
      `/instruments/future-option-products/${exchange}/${rootSymbol}`,
      {},
      {}
    );
  ...
  async getFutureOptions(queryParams = {}) {
    ...
    const futureOptions = await this.httpClient.getData(
  ...
  async getSingleFutureOption(symbol: string) {
    ...
    const singleFutureOption = await this.httpClient.getData(
  ...
  async getFuturesProducts() {
    ...
    const futuresProducts = await this.httpClient.getData(
  ...
  async getSingleFutureProduct(exchange: string, code: string) {
    ...
    const singleFutureProduct = await this.httpClient.getData(
  ...
  async getQuantityDecimalPrecisions() {
    ...
    const quantityDecimalPrecisions = await this.httpClient.getData(
  ...
  async getWarrants(queryParams = {}) {
    ...
    const warrants = await this.httpClient.getData(
  ...
  async getSingleWarrant(symbol: string) {
    ...
    const singleWarrant = await this.httpClient.getData(
  ...
  async getNestedFutureOptionChains(symbol: string) {
    ...
    const nestedFutureOptionChains = await this.httpClient.getData(
  ...
  async getFutureOptionChain(symbol: string) {
    ...
    const futureOptionChain = await this.httpClient.getData(
  ...
  async getNestedOptionChain(symbol: string) {
    ...
    const nestedOptionChain = await this.httpClient.getData(
  ...
  async getCompactOptionChain(symbol: string) {
    ...
    const compactOptionChain = await this.httpClient.getData(
  ...
  async getOptionChain(symbol: string) {
    ...
    const optionChain = await this.httpClient.getData(
