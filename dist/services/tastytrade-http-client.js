...
var TastytradeHttpClient = /** @class */ (function () {
    ...
    TastytradeHttpClient.prototype.postData = function (url, data, headers) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.executeRequest('post', url, data, headers)];
            });
        });
    };
    TastytradeHttpClient.prototype.putData = function (url, data, headers) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.executeRequest('put', url, data, headers)];
            });
        });
    };
    TastytradeHttpClient.prototype.patchData = function (url, data, headers) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.executeRequest('patch', url, data, headers)];
            });
        });
    };
    TastytradeHttpClient.prototype.deleteData = function (url, headers) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.executeRequest('delete', url, headers)];
            });
        });
    };
    return TastytradeHttpClient;
}());
exports.default = TastytradeHttpClient;
